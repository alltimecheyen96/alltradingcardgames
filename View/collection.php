...
<tbody>
<?php
	$result = $collectionObject->get_all();
  ...
  <tr>
    ...
    <td><?php $gameSet=  $collectionObject->get_GameSet($key->CardNumber);
		...
		<input type="hidden" value = "<?php echo $key->CardID ?>" name ="CardID" ></input>
		<input type="hidden" value = "<?php echo $_SESSION['id']?>" name = "UserID"  ></input>
		<td> <input type="submit" value = "Add" name= "Add" class="btn"></input> </td>
		</form>
	</tr>
<?php } ?>
</tbody>
